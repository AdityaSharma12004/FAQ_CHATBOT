...
model = load_model(r'C:\Users\hp\chatbot\FAQ-Chatbot\model-v1.keras')
tokenizer_t = joblib.load(r'C:\Users\hp\chatbot\FAQ-Chatbot\tokenizer_t.pkl')
vocab = joblib.load(r'C:\Users\hp\chatbot\FAQ-Chatbot\vocab.pkl')
...
def get_bot_response(): 
    ...
    df2 = pd.read_csv(r"C:\Users\hp\chatbot\FAQ-Chatbot\response.csv") 
